...
def list_courses_wrapper(_: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.list_courses())

def list_assignments_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).list_assignments())

def list_unsubmitted_assignments_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).list_unsubmitted_assignments())

def list_documents_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).list_documents())

def list_announcements_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).list_announcements())

def list_course_tree_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).build_tree())

def list_entry_children_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).entry(args.entry_id).list_children())

def entry_summary_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).entry(args.entry_id).summary())
...
def search_assignments_by_title_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).find_assignments_by_title(args.query))

def search_documents_by_title_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).find_documents_by_title(args.query))

def search_videos_by_title_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).find_videos_by_title(args.query))

def search_entry_by_title_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).find_entry_by_title(args.query))

def search_announcements_by_title_wrapper(args: BaseModel) -> Any:
    bb = load_or_login()
    return json_safe(bb.course(int(args.course)).find_announcements_by_title(args.query))
